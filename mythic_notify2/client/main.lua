RegisterNetEvent('mythic_notify2:client:SendAlert')
AddEventHandler('mythic_notify2:client:SendAlert', function(data)
	SendAlert(data.type, data.text, data.length, data.style)
end)

RegisterNetEvent('mythic_notify2:client:PersistentAlert')
AddEventHandler('mythic_notify2:client:PersistentAlert', function(data)
