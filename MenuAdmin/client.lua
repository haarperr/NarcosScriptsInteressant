...
function OpenPersonnelMenu()
	...
	ESX.TriggerServerCallback('NB:getUsergroup', function(group)
		...
		table.insert(elements, {label = 'Sobre mim',		value = 'menuperso_moi'})
		if (IsInVehicle()) then
			local vehicle = GetVehiclePedIsIn( GetPlayerPed(-1), false )
			if ( GetPedInVehicleSeat( vehicle, -1 ) == GetPlayerPed(-1) ) then
				table.insert(elements, {label = 'Veículo',					value = 'menuperso_vehicule'})
			end
		end
		table.insert(elements, {label = 'GPS Rápido',			value = 'menuperso_gpsrapide'})
		if PlayerData.job.grade_name == 'boss' then
			table.insert(elements, {label = 'Gestão de negócios',			value = 'menuperso_grade'})
		end
		...
		ESX.UI.Menu.Open(
			...
			function(data, menu)
				...
				if playergroup == 'mod' then
					table.insert(elements, {label = 'TP para Jogador',    							value = 'menuperso_modo_tp_toplayer'})
					table.insert(elements, {label = 'TP para Mim',             			value = 'menuperso_modo_tp_playertome'})
					--table.insert(elements, {label = 'TP / Coordenadas [WIP]',						value = 'menuperso_modo_tp_pos'})
					--table.insert(elements, {label = 'NoClip',										value = 'menuperso_modo_no_clip'})
					--table.insert(elements, {label = 'Modo invencível',									value = 'menuperso_modo_godmode'})
					--table.insert(elements, {label = 'Modo Fantasma',								value = 'menuperso_modo_mode_fantome'})
					--table.insert(elements, {label = 'Reparar Veículo',							value = 'menuperso_modo_vehicle_repair'})
					--table.insert(elements, {label = 'Spawnar Veículo ',							value = 'menuperso_modo_vehicle_spawn'})
					--table.insert(elements, {label = 'Virar Veículo',								value = 'menuperso_modo_vehicle_flip'})
					--table.insert(elements, {label = 'Dar Dinheiro',						value = 'menuperso_modo_give_money'})
					...
					table.insert(elements, {label = 'Mostrar / ocultar nomes de jogadores',	value = 'menuperso_modo_showname'})
                    table.insert(elements, {label = 'Curar',		value = 'menuperso_modo_heal_player'})
					--table.insert(elements, {label = 'TP / Marca',							value = 'menuperso_modo_tp_marcker'})
					--table.insert(elements, {label = 'Curar',					value = 'menuperso_modo_heal_player'})
					--table.insert(elements, {label = 'Modo Assistir [WIP]',						value = 'menuperso_modo_spec_player'})
					--table.insert(elements, {label = 'Mudar Aparência',									value = 'menuperso_modo_changer_skin'})
					--table.insert(elements, {label = 'Guardar Aparência ',									value = 'menuperso_modo_save_skin'})
				end
				...
				if playergroup == 'admin' then
					...
					--table.insert(elements, {label = 'TP / Marca',							value = 'menuperso_modo_tp_marcker'})
					--table.insert(elements, {label = 'Curar',					value = 'menuperso_modo_heal_player'})
					--table.insert(elements, {label = 'Modo Assistir',						value = 'menuperso_modo_spec_player'})
					table.insert(elements, {label = 'Mudar Aparência',									value = 'menuperso_modo_changer_skin'})
					table.insert(elements, {label = 'Guardar Aparência',									value = 'menuperso_modo_save_skin'})
				end
				...
				if data.current.value == 'menuperso_moi' then
					...
					local elements = {}
					table.insert(elements, {label = 'Telemovel',    							value = 'menuperso_moi_telephone'})
					table.insert(elements, {label = 'Inventário',             					value = 'menuperso_moi_inventaire'})
					table.insert(elements, {label = 'Faturas',							value = 'menuperso_moi_factures'})
				...
				if data.current.value == 'menuperso_actions' then
					...
					ESX.UI.Menu.Open(
						'default', GetCurrentResourceName(), 'menuperso_actions',
						{
							...
							align    = 'center',
							elements = {
								{label = 'Anular Animações',  value = 'menuperso_actions__annuler'},
								--{label = 'Ações [WIP]',     value = 'menuperso_actions_pipi'},
								...
								ESX.UI.Menu.Open(
									'default', GetCurrentResourceName(), 'menuperso_actions_Salute',
									{
										...
										elements = {
											...
											{label = 'Apertar as mãos',     value = 'menuperso_actions_Salute_serrerlamain'},
											{label = 'high5',     value = 'menuperso_actions_Salute_tapeen5'},
							...
							if data2.current.value == 'menuperso_actions_Humor' then
								ESX.UI.Menu.Open(
									'default', GetCurrentResourceName(), 'menuperso_actions_Humor',
									{
										...
										align    = 'center',
										elements = {
											{label = 'Aplaudir',  value = 'menuperso_actions_Humor_feliciter'},
											{label = 'Super',     value = 'menuperso_actions_Humor_super'},
											{label = 'Acalmar',     value = 'menuperso_actions_Humor_calmetoi'},
											{label = 'Ter medo',  value = 'menuperso_actions_Humor_avoirpeur'},
											{label = 'Não é possível!',  value = 'menuperso_actions_Humor_cestpaspossible'},
											{label = 'Abraçar',  value = 'menuperso_actions_Humor_enlacer'},
											{label = 'Sacar o dedo',  value = 'menuperso_actions_Humor_doightdhonneur'},
											{label = 'Punheta',  value = 'menuperso_actions_Humor_branleur'},
											{label = 'Tiro na cabeça',  value = 'menuperso_actions_Humor_balledanslatete'},
											{label = 'Impaciente',  value = 'menuperso_actions_Humor_impatient'},
										},
									},
									function(data3, menu3)
										...
										if data3.current.value == 'menuperso_actions_Humor_impatient' then
											animsAction({ anim = "WORLD_HUMAN_STAND_IMPATIENT" })
										end
								...
								ESX.UI.Menu.Open(
									'default', GetCurrentResourceName(), 'menuperso_actions_Travail',
									{
										...
										elements = {
											...
											{label = 'Mecanico',     value = 'menuperso_actions_Travail_depanneur'},
											{label = 'Apontar algo',  value = 'menuperso_actions_Travail_prendredesnotes'},
											{label = 'Inspecionar',  value = 'menuperso_actions_Travail_inspecter'},
											{label = 'Policia',  value = 'menuperso_actions_Travail_cop'},
											{label = 'Guarda',  value = 'menuperso_actions_Travail_guard'},
											{label = 'Martelar',  value = 'menuperso_actions_Travail_hammer'},
											{label = 'Paparazzi',  value = 'menuperso_actions_Travail_paparazzi'},
											{label = 'Investigar',  value = 'menuperso_actions_Travail_investiguer'},
										},
									},
									function(data3, menu3)
										...
										if data3.current.value == 'menuperso_actions_Travail_cop' then
											animsActionScenario({anim = "WORLD_HUMAN_COP_IDLES" })
										end

										if data3.current.value == 'menuperso_actions_Travail_guard' then
											animsActionScenario({anim = "WORLD_HUMAN_GUARD_STAND" })
										end

										if data3.current.value == 'menuperso_actions_Travail_hammer' then
											animsActionScenario({anim = "WORLD_HUMAN_HAMMERING" })
										end

										if data3.current.value == 'menuperso_actions_Travail_paparazzi' then
											animsActionScenario({anim = "WORLD_HUMAN_PAPARAZZI" })
										end

										if data3.current.value == 'menuperso_actions_Travail_investiguer' then
											animsActionScenario({anim = "CODE_HUMAN_POLICE_INVESTIGATE" })
										end
								...
								ESX.UI.Menu.Open(
									'default', GetCurrentResourceName(), 'menuperso_actions_Others',
									{
										...
										elements = {
											...
											{label = 'Binóculos',     value = 'menuperso_actions_Others_regarderauxjumelles'},
											{label = 'Yoga',     value = 'menuperso_actions_Others_faireduyoga'},
											{label = 'Estátua',     value = 'menuperso_actions_Others_fairelastatut'},
											{label = 'Jogging',     value = 'menuperso_actions_Others_fairedujogging'},
											{label = 'Mostrar Musculos',     value = 'menuperso_actions_Others_fairedesetirements'},
											{label = 'Puta',     value = 'menuperso_actions_Others_racoller'},
											{label = 'Puta1',     value = 'menuperso_actions_Others_racoller2'},
											{label = 'Sentar',     value = 'menuperso_actions_Others_sasseoir'},
											{label = 'Sentar no chão)',     value = 'menuperso_actions_Others_sasseoirparterre'},
											{label = 'Encostar',     value = 'menuperso_actions_Others_attendre'},
											{label = 'Limpar',     value = 'menuperso_actions_Others_nettoyerquelquechose'},
											{label = 'Levantar as mãos',     value = 'menuperso_actions_Others_leverlesmains'},
											{label = 'Posição de busca',     value = 'menuperso_actions_Others_positiondefouille'},
					...
					ESX.UI.Menu.Open(
						'default', GetCurrentResourceName(), 'menuperso_gpsrapide',
						{
							...
							elements = {
								...
								{label = 'Policia',              value = 'menuperso_gpsrapide_comico'},
								{label = 'Hospital principal', value = 'menuperso_gpsrapide_hopital'},
								{label = 'Concessionário',  value = 'menuperso_gpsrapide_concessionnaire'}
							},
						},
						function(data2, menu2)
							...
							if data2.current.value == 'menuperso_gpsrapide_poleemploi' then
								...
								ESX.ShowNotification("Adicionado destino no GPS!")
							end
				...
				if data.current.value == 'menuperso_grade' then
					ESX.UI.Menu.Open(
						...
						{
							title    = 'Gestão empresa',
							align    = 'center',
							elements = {
								{label = 'Recruta',     value = 'menuperso_grade_recruter'},
								{label = 'Despedir',              value = 'menuperso_grade_virer'},
								{label = 'Promover', value = 'menuperso_grade_promouvoir'},
								{label = 'Remover',  value = 'menuperso_grade_destituer'}
							},
						},
						function(data2, menu2)
...
function OpenVehiculeMenu()
	...
	--[[if vehiculeON then
		table.insert(elements, {label = 'Desligar o motor',			value = 'menuperso_vehicule_MoteurOff'})
	else
		table.insert(elements, {label = 'Ligar o motor',		value = 'menuperso_vehicule_MoteurOn'})
	end]]
	
	if porteAvantGaucheOuverte then
		table.insert(elements, {label = 'Fechar a porta esquerda',	value = 'menuperso_vehicule_fermerportes_fermerportegauche'})
	else
		table.insert(elements, {label = 'Abrir a porta esquerda',		value = 'menuperso_vehicule_ouvrirportes_ouvrirportegauche'})
	end
	
	if porteAvantDroiteOuverte then
		table.insert(elements, {label = 'Fechar a porta direita',	value = 'menuperso_vehicule_fermerportes_fermerportedroite'})
	else
		table.insert(elements, {label = 'Abrir a porta direita',		value = 'menuperso_vehicule_ouvrirportes_ouvrirportedroite'})
	end
	
	if porteArriereGaucheOuverte then
		table.insert(elements, {label = 'Fechar a porta traseira esquerda',	value = 'menuperso_vehicule_fermerportes_fermerportearrieregauche'})
	else
		table.insert(elements, {label = 'Abrir a porta traseira esquerda',		value = 'menuperso_vehicule_ouvrirportes_ouvrirportearrieregauche'})
	end
	
	if porteArriereDroiteOuverte then
		table.insert(elements, {label = 'Fechar a porta traseira direita',	value = 'menuperso_vehicule_fermerportes_fermerportearrieredroite'})
	else
		table.insert(elements, {label = 'Fechar tem porta traseira direita',		value = 'menuperso_vehicule_ouvrirportes_ouvrirportearrieredroite'})
	end
	
	if porteCapotOuvert then
		table.insert(elements, {label = 'Fechar o capô',	value = 'menuperso_vehicule_fermerportes_fermercapot'})
	else
		table.insert(elements, {label = 'Abrir o capô',		value = 'menuperso_vehicule_ouvrirportes_ouvrircapot'})
	end
	
	if porteCoffreOuvert then
		table.insert(elements, {label = 'Fechar a bagageira',	value = 'menuperso_vehicule_fermerportes_fermercoffre'})
	else
		table.insert(elements, {label = 'Abrir a bagageira',		value = 'menuperso_vehicule_ouvrirportes_ouvrircoffre'})
	end
	
	if porteAutre1Ouvert then
		table.insert(elements, {label = 'Fechar outro 1',	value = 'menuperso_vehicule_fermerportes_fermerAutre1'})
	else
		table.insert(elements, {label = 'Abrir outro 1',		value = 'menuperso_vehicule_ouvrirportes_ouvrirAutre1'})
	end
	
	if porteAutre2Ouvert then
		table.insert(elements, {label = 'Fechar outro 2',	value = 'menuperso_vehicule_fermerportes_fermerAutre2'})
	else
		table.insert(elements, {label = 'Abrir outro 2',		value = 'menuperso_vehicule_ouvrirportes_ouvrirAutre2'})
	end
	
	if porteToutOuvert then
		table.insert(elements, {label = 'Fechar tudo',	value = 'menuperso_vehicule_fermerportes_fermerTout'})
	else
		table.insert(elements, {label = 'Abrir tudo',		value = 'menuperso_vehicule_ouvrirportes_ouvrirTout'})
	end
...
function admin_tp_toplayer()
	...
	Notify("~b~Insere o ID do jogador...")
	inputgoto = 1
end
...
function admin_no_clip()
  ...
  if noclip then -- activé
	...
	Notify("Noclip ~g~Activado")
  else -- désactivé
    SetEntityInvincible(ped, false)
    SetEntityVisible(ped, true, false)
	Notify("Noclip ~r~Desactivado")
  end
end
...
function admin_godmode()
  ...
  if godmode then -- activé
		SetEntityInvincible(ped, true)
		Notify("Modo invincivel ~g~Activado")
	else
		SetEntityInvincible(ped, false)
		Notify("Modo invincivel ~r~Desactivado")
  end
end
-- FIN GOD MODE
...
function admin_mode_fantome()
  ...
  if invisible then -- activé
		SetEntityVisible(ped, false, false)
		Notify("Modo Fantasma ~g~activado")
	else
		SetEntityVisible(ped, true, false)
		Notify("Modo fantasma ~r~desactivado")
  end
end
-- FIN INVISIBLE
...
function admin_vehicle_spawn()
	DisplayOnscreenKeyboard(true, "FMMC_KEY_TIP8", "", "", "", "", "", 120)
	Notify("~b~Insere o nome do veículo...")
	inputvehicle = 1
end
	...
	while true do
		...
		local vehicleidd = GetOnscreenKeyboardResult()
				...
				Citizen.CreateThread(function()
					...
					Notify("Veículo entregue, boa rota")
				end)
...
function admin_give_money()
	DisplayOnscreenKeyboard(true, "FMMC_KEY_TIP8", "", "", "", "", "", 120)
	Notify("~b~Insere o valor a ser concedido...")
	inputmoney = 1
end
...
function modo_showname()
	if showname then
		...
		Notify("Abre / fecha o menu de pausa para exibir os nomes")
		showname = true
	end
end
...
function animsAction(animObj)
	if (IsInVehicle()) then
		local source = GetPlayerServerId();
		ESX.ShowNotification("Sai do teu veículo para fazeres isso !")
	else
		Citizen.CreateThread(function()
