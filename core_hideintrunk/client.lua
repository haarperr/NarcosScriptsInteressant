	...
	Citizen.CreateThread(function()
	  	while true do
		    ...
		    if IsDisabledControlPressed(0, 19) and IsDisabledControlJustReleased(1, 46) and GetVehiclePedIsIn(player, false) == 0 and DoesEntityExist(vehicle) and IsEntityAVehicle(vehicle) then
			...
			if DoesEntityExist(vehicle) then
				if IsEntityAVehicle(vehicle) and not inside and GetVehiclePedIsIn(player, false) == 0 then
							SetTextComponentFormat("STRING")
