	...
	while true do Citizen.Wait(1)
		...
		if(IsPedInAnyVehicle(MyPed, false))then
			...
			if HUD.DamageSystem then
				...
				drawRct(UI.x + 0.1661, 	UI.y + 0.809, 0.005,0.173,255,0,0,100)
				drawRct(UI.x + 0.1661, 	UI.y + 0.809, 0.005,VehBodyHP/5800,0,0,0,255)
				drawRct(UI.x + 0.159, 	UI.y + 0.809, 0.005, VehEngineHP / 5800,0,0,0,255)
			end
